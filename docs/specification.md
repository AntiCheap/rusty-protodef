...
* **[protodef-yaml](https://extremeheat.github.io/protodef-yaml/)** compiles a more readable format into mcd protodef.
* **[node-protodef](https://github.com/ProtoDef-io/node-protodef)** is the first JS implementation (compiled and interpreted).
* **[minecraft-data](https://github.com/PrismarineJS/minecraft-data)** uses protodef to specify the game's protocol versions.
...
### Introduction
[ProtoDef](https://github.com/ProtoDef-io/ProtoDef) is a specification to make data parsing and serialization easier, started as a contribution to PrismarineJS. It is lanaguage independant and it can describe internet protocols (or file formats) with structured data using JSON. Protodef compilers can convert a protocol description into its functions to parse and serialize data.

|  Language| Compiler |
|--|--|
| Node.js| node-protodef |
| Elixir | elixir-protodef |
| C | mcd2c |
| C++ | mcd2cpp |
| Rust | protodef-rs |

The project **[protodef-yaml](https://extremeheat.github.io/protodef-yaml/)** improves the readibility of the protocol

 generating the JSON from another format.
